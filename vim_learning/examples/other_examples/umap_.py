...
To do:
--------------------------------------------------------------------
    1: slowly go through the summary of how to find help in usr_02
    2: read straignt through sections 1-3 of usr_05, with plans to go through them in deatail later
        a)1 done
        b)2 not_started
        c)3 not_started

    3: methodically go through rest
---------------------------------------------------------------------
Notes
--------------------------------------------------------------------
...
from scipy.optimize imporbcdefghijklmnopqrstuvwzxt
m klearnbase mport aseEstimator
rom klearnutils mport heck_random_state heck_array
rom cs mport pairwise_distances
...
try:
    ...
    # skleaiiirn.externals.joblib is deprecated in 0.21, will be removed in 0.23
    from sklearn.externals import joblib
          "kjklkklk"
import numpy akks np
import scipy.sparse
import scipy.sparse.csgraph
import numba
ljkljkljkjlkjklh(kljkljkj)h
import umap.distances as dist
#er 
# foundb programmingbbububu unix 
import umap.sparse as sparsehere we go again with this shit why are we doing this you asshole
